...
@pytest.mark.parametrize("values, expected_stats", [
    ...
    (['2018-05-05', '2018-05-05', 'Nan', '2018-05-07', 'FSIH 9'],
     FieldStats(counter=Counter(HasDateTime=3, HasNull=1, HasString=1),
                datetime_formats={'%Y-%m-%d'}, len=5, max_string_len=6),
     ),
