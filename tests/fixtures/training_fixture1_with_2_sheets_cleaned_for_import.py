...
@pytest.fixture
def cleaned_csv_with_2_sheets_combined_for_import_fixture():
    return [{
        'casualty': False,
        ...
        'casualty': False,
        'value_current': 180000,
        'last_payment_date': None,
        'year': '2011',
        'score': 233,
        'slope': Decimal('-0.0204')
    }, {
        'casualty': True,
        'value_current': 973800,
        'last_payment_date': datetime.datetime(2018, 5, 5, 0, 0),
        'year': '2014',
        'score': 1000,
        'slope': Decimal('0.1091')
    }, {
        'casualty': False,
        'value_current': 9300,
        'last_payment_date': datetime.datetime(2018, 5, 8, 0, 0),
        'year': '2017',
        'score': None,
        'slope': Decimal('0.0018')
    }, {
        'casualty': None,
        'value_current': 1370000,
        'last_payment_date': None,
