...
class TestCleaner:
    ...
    @pytest.mark.parametrize("content_type, path, content, sheet_names", [  # NOQA
        ...
        ('tsv', None, io.StringIO(training_fixture1_tab_content_str), None),
        ('tsv', None, training_fixture1_tab_content_str, None),
        ('tsv', None, training_fixture1_tab_content_str.encode('utf-8'), None),
        ('tsv', None, io.BytesIO(training_fixture1_tab_content_str.encode('utf-8')), None),
        ('tsv', training_fixture1_tab_path, None, None),
